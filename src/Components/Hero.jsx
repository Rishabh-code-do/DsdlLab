...
const Hero = () => {
  return (
    <>
     <div className='hero'>
       <p className='font1'>"Unleashing Power Where Supercomputing Transcends Boundaries and Innovates."</p>
       ...
       <div className='btn'>
        <button className='Button'><a href="https://forms.gle/kepYnvk4dFXDCm8L7" target='_blank'>Request Access</a></button>
